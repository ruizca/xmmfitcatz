...
def define_model_po(ids, z, nhgal) :
    ...
    for sid in ids :
        if sid == 1 :
            model_str = "xsphabs.galabs*xszpowerlw.po"
...
def define_model_wapo(ids, z, nhgal) :
    ...
    for sid in ids :
        if sid == 1 :
            model_str = "xsphabs.galabs*xszphabs.intabs*xszpowerlw.po"
            set_source(sid, model_str)
        else :
...
def define_model_wamekal(ids, z, nhgal) :
    ...
    for sid in ids :
        if sid == 1 :
            model_str = "xsphabs.galabs*xszphabs.intabs*xsmekal.thermal"
            set_source(sid, model_str)
        else :
...
def define_model_mekal(ids, z, nhgal) :
    ...
    for sid in ids :
        if sid == 1 :
            model_str = "xsphabs.galabs*xsmekal.thermal"
            set_source(sid, model_str)
        else :
...
def define_model_wabb(ids, z, nhgal) :
    ...
    for sid in ids :
        if sid == 1 :
            model_str = "xsphabs.galabs*xszphabs.intabs*xszbbody.thermal"
            set_source(sid, model_str)
        else :
            model_str = "const1d.c" + str(sid) + "*galabs*intabs*thermal"
            set_source(sid, model_str)
...
def define_model_bb(ids, z, nhgal) :
    ...
    for sid in ids :
        if sid == 1 :
            model_str = "xsphabs.galabs*xszbbody.thermal"
            set_source(sid, model_str)
        else :
            model_str = "const1d.c" + str(sid) + "*galabs*thermal"
            set_source(sid, model_str)
...
def define_model_wamekalpo(ids, z, nhgal) :
    ...
    for sid in ids :
        if sid == 1 :
            model_str = "xsphabs.galabs*xszphabs.intabs1*(xsmekal.thermal + xszphabs.intabs2*xszpowerlw.po)"
            set_source(sid, model_str)
        else :
...
def define_model_wapopo(ids, z, nhgal) :
    ...
    for sid in ids :
        if sid == 1 :
            model_str = "xsphabs.galabs*xszphabs.intabs1*(xszpowerlw.po1 + xszphabs.intabs2*xszpowerlw.po2)"
            set_source(sid, model_str)
        else :
...
def define_model_wabbpo(ids, z, nhgal) :
    ...
    for sid in ids :
        if sid == 1 :
            model_str = "xsphabs.galabs*xszphabs.intabs*(xszbbody.thermal + xszpowerlw.po)"
            set_source(sid, model_str)
        else :
